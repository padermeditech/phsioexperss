...
[{if !$oxcmp_user->oxuser__oxpassword->value}]
    <form class="form" id="login" name="login" action="[{$oViewConf->getSslSelfLink()}]" method="post">
        <div id="loginBox" class="loginBox" [{if $bIsError}]style="display: block;"[{/if}]>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <a class="forgotPasswordOpener btn btn-default" href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=forgotpwd"}]" title="[{oxmultilang ident="FORGOT_PASSWORD"}]" rel="nofollow">?</a>
                    </span>
                </div>
            </div>
            ...
            [{if !$oxcmp_user}]
                <a class="btn" id="registerLink" role="button" href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=register"}]" title="[{oxmultilang ident="REGISTER"}]" rel="nofollow">[{oxmultilang ident="REGISTER"}]</a>
            [{/if}]
