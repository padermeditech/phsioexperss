            ...
            <table cellspacing="0" cellpadding="0" border="0">
              [{block name="admin_article_main_form"}]
                  ...
                  <tr>
                    ...
                    <td class="edittext">
						<textarea class="editinput" name="editval[oxarticles__oxsearchkeys]" style="width:220px; height:200px; font-size:10px;">[{$edit->oxarticles__oxsearchkeys->value}]</textarea>
			...
			<table>
			 <tr>
			  <td>
				...
				<textarea style="width:100%; height:150px;" class="editinput" name="editval[oxarticles__oxshortdesc]">[{$edit->oxarticles__oxshortdesc->value}]</textarea>
			  </td>
			 </tr>
			 <tr>
			  <td>
