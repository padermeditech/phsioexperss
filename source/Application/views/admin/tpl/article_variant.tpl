        ...
        <table cellspacing="0" cellpadding="0" border="0" width="730">
          ...
          <tr>
            [{block name="admin_article_variant_parent"}]
                ...
                <td class="[{$listclass}]">&nbsp;</td>
                <td class="[{$listclass}]"><input type="text" class="editinput" size="80" maxlength="[{$edit->oxarticles__oxvarselect->fldmax_length}]" name="editval[oxarticles__oxvarselect]" value="[{$edit->oxarticles__oxvarselect->value}]" [{$readonly}]></td>
                <td class="[{$listclass}]"><input type="text" class="editinput" size="5" maxlength="[{$edit->oxarticles__oxartnum->fldmax_length}]" name="editval[oxarticles__oxartnum]" value="[{$edit->oxarticles__oxartnum->value}]" [{$readonly}]></td>
                ...
                <td class="[{$listclass}]">&nbsp;</td>
                <td class="[{$listclass}]"><input type="text" class="editinput" size="4" maxlength="[{$edit->oxarticles__oxstock->fldmax_length}]" name="editval[oxarticles__oxstock]" value="[{$edit->oxarticles__oxstock->value}]" [{$readonly}]></td>
                <td class="[{$listclass}]">
          ...
          <tr id="test_variant.[{$_cnt1}]">
            ...
            <td class="[{$listclass}]"><input type="text" class="editinput" size="80" maxlength="[{$listitem->oxarticles__oxvarselect->fldmax_length}]" name="editval[[{$listitem->oxarticles__oxid->value}]][oxarticles__oxvarselect]" value="[{$listitem->oxarticles__oxvarselect->value}]" [{$readonly}]></td>
            <td class="[{$listclass}]"><input type="text" class="editinput" size="5" maxlength="[{$listitem->oxarticles__oxartnum->fldmax_length}]" name="editval[[{$listitem->oxarticles__oxid->value}]][oxarticles__oxartnum]" value="[{$listitem->oxarticles__oxartnum->value}]" [{$readonly}]></td>
            ...
            <td class="[{$listclass}]"><input type="text" class="editinput" size="4" maxlength="[{$listitem->oxarticles__oxsort->fldmax_length}]" name="editval[[{$listitem->oxarticles__oxid->value}]][oxarticles__oxsort]" value="[{$listitem->oxarticles__oxsort->value}]" [{$readonly}]></td>
            <td class="[{$listclass}]"><input type="text" class="editinput" size="4" maxlength="[{$listitem->oxarticles__oxstock->fldmax_length}]" name="editval[[{$listitem->oxarticles__oxid->value}]][oxarticles__oxstock]" value="[{$listitem->oxarticles__oxstock->value}]" [{$readonly}]></td>
            <td class="[{$listclass}]">
          ...
          <tr>
            ...
            [{block name="admin_article_variant_newitem"}]
                ...
                <td class="[{$listclass}]"><input type="text" class="editinput" size="80" maxlength="[{$listitem->oxarticles__oxvarselect->fldmax_length}]" name="editval[oxarticles__oxvarselect]" value="" [{$readonly}]></td>
                <td class="[{$listclass}]"><input type="text" class="editinput" size="5" maxlength="[{$listitem->oxarticles__oxartnum->fldmax_length}]" name="editval[oxarticles__oxartnum]" value="" [{$readonly}]></td>
                ...
                <td class="[{$listclass}]"><input type="text" class="editinput" size="4" maxlength="[{$listitem->oxarticles__oxsort->fldmax_length}]" name="editval[oxarticles__oxsort]" value="" [{$readonly}]></td>
                <td class="[{$listclass}]"><input type="text" class="editinput" size="4" maxlength="[{$listitem->oxarticles__oxstock->fldmax_length}]" name="editval[oxarticles__oxstock]" value="" [{$readonly}]></td>
                <td class="[{$listclass}]">
