...
">
                                                                        <?php if ($this->_tpl_vars['osubcat']->getIconUrl()): ?>
                                                                            <span class="img"><img src="<?php echo $this->_tpl_vars['osubcat']->getIconUrl(); ?>
" alt="<?php echo $this->_tpl_vars['osubcat']->oxcategories__oxtitle->value; ?>
" title="<?php echo $this->_tpl_vars['osubcat']->oxcategories__oxtitle->value; ?>
"></span>
                                                                        <?php endif; ?>
                                                                        <span class="title"><?php echo $this->_tpl_vars['osubcat']->oxcategories__oxtitle->value; ?>
</span>
                                                                    </a>
                                                                </li>
                                                            <?php endif; ?>
