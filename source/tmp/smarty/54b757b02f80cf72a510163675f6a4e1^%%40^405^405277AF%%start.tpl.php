...
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxscript', 'page/shop/start.tpl', 4, false),array('modifier', 'oxmultilangassign', 'page/shop/start.tpl', 20, false),array('block', 'oxifcontent', 'page/shop/start.tpl', 46, false),array('insert', 'oxid_tracker', 'page/shop/start.tpl', 64, false),)), $this); ?>
<?php ob_start(); ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<div class="responsiveflexslider">
		<?php if ($this->_tpl_vars['oCategoryArticles'] && $this->_tpl_vars['oCategoryArticles']->count()): ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/product/flexslider-list.tpl", 'smarty_include_vars' => array('type' => $this->_tpl_vars['oViewConf']->getViewThemeParam('sStartPageListDisplayType'),'head' => 'Gebrauchte Behandlungsliegen','subhead' => ((is_array($_tmp='START_NEWEST_SUBHEADER')) ? $this->_run_mod_handler('oxmultilangassign', true, $_tmp) : smarty_modifier_oxmultilangassign($_tmp)),'listId' => 'categoryItems','products' => $this->_tpl_vars['oCategoryArticles'],'rsslink' => $this->_tpl_vars['rsslinks']['newestArticles'],'rssId' => 'rssNewestProducts','showMainLink' => true,'iProductsPerLine' => 4)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['oView']->getClassName() == 'start'): ?>
		<div class="promotion">
			<div class="row">
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/promoboxes2.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			</div>
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/aktionenshop.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/gebrauchtboerse.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
