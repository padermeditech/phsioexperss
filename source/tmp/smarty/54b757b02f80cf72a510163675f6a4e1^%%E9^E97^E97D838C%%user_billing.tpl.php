...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'regex_replace', 'form/fieldset/user_billing.tpl', 7, false),array('modifier', 'oxmultilangassign', 'form/fieldset/user_billing.tpl', 67, false),array('modifier', 'trim', 'form/fieldset/user_billing.tpl', 159, false),array('modifier', 'escape', 'form/fieldset/user_billing.tpl', 159, false),array('modifier', 'cat', 'form/fieldset/user_billing.tpl', 233, false),array('function', 'oxmultilang', 'form/fieldset/user_billing.tpl', 33, false),array('function', 'oxscript', 'form/fieldset/user_billing.tpl', 179, false),)), $this); ?>
...
<?php endif; ?>
<?php if (isset ( $this->_tpl_vars['invadr']['oxuser__oxsal'] )): ?>
    <?php $this->assign('oxuser__oxsal', $this->_tpl_vars['invadr']['oxuser__oxsal']); ?>
<?php else: ?>
    <?php $this->assign('oxuser__oxsal', $this->_tpl_vars['oxcmp_user']->oxuser__oxsal->value); ?>
<?php endif; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "form/fieldset/salutation.tpl", 'smarty_include_vars' => array('name' => "invadr[oxuser__oxsal]",'value' => $this->_tpl_vars['oxuser__oxsal'],'class' => "form-control selectpicker",'id' => 'invadr_oxuser__oxfname')));
...
<?php if ($this->_tpl_vars['oViewConf']->isCheckoutNonKlarnaCountry() && $this->_tpl_vars['oView']->getIsOrderStep()): ?>
    <?php ob_start(); ?>
        <div class="col-lg-2">
            <button type="button"
                    class="btn btn-default js-other-country"><?php echo smarty_function_oxmultilang(array('ident' => 'TCKLARNA_OTHER_COUNTRY'), $this);?>
</button>
        </div>
    <?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('otherCountry', ob_get_contents());ob_end_clean(); ?>
    <script>
        var otherCountryButton = '<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['otherCountry'])) ? $this->_run_mod_handler('trim', true, $_tmp) : trim($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
';
    </script>
    <?php ob_start(); ?>
    ...
    <?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('dataCollectionJS', ob_get_contents());ob_end_clean(); ?>

    <?php echo smarty_function_oxscript(array('add' => 'var $dropdown = $("#invCountrySelect").parent();
$dropdown.removeClass("col-lg-9").addClass("col-lg-7");
var $otherCountry = $.parseHTML(otherCountryButton);
$dropdown.parent().append($otherCountry);','priority' => 10), $this);?>

    <?php echo smarty_function_oxscript(array('add' => $this->_tpl_vars['dataCollectionJS'],'priority' => 10), $this);?>
