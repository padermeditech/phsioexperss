...
smarty_core_load_plugins(array('plugins' => array(array('block', 'oxifcontent', 'widget/footer/info.tpl', 3, false),array('function', 'oxgetseourl', 'widget/footer/info.tpl', 28, false),array('function', 'oxmultilang', 'widget/footer/info.tpl', 28, false),array('modifier', 'cat', 'widget/footer/info.tpl', 28, false),)), $this); ?>
...
" rel="nofollow"><?php echo $this->_tpl_vars['oCont']->oxcontents__oxtitle->value; ?>
        ...
        <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_oxifcontent($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php $this->_tag_stack[] = array('oxifcontent', array('ident' => 'oxruecksendung','object' => 'oCont')); $_block_repeat=true;smarty_block_oxifcontent($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
            <li><a href="<?php echo $this->_tpl_vars['oCont']->getLink(); ?>
" rel="nofollow"><?php echo $this->_tpl_vars['oCont']->oxcontents__oxtitle->value; ?>
</a></li>
        <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_oxifcontent($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
" rel="nofollow"><?php echo smarty_function_oxmultilang(array('ident' => 'NEWS'), $this);?>
</a></li>
        <?php endif; ?>
    </ul>