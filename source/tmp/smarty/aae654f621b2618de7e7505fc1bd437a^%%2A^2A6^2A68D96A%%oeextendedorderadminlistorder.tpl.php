<?php /* Smarty version 2.6.31, created on 2022-12-28 11:51:54
         compiled from oeextendedorderadminlistorder.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'oeextendedorderadminlistorder.tpl', 1, false),array('modifier', 'cat', 'oeextendedorderadminlistorder.tpl', 7, false),array('modifier', 'oxformdate', 'oeextendedorderadminlistorder.tpl', 80, false),array('modifier', 'oxaddslashes', 'oeextendedorderadminlistorder.tpl', 154, false),array('function', 'oxmultilang', 'oeextendedorderadminlistorder.tpl', 66, false),)), $this); ?>
...
">
            ...
            <tr>
                ...
                <td class="listheader first"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, '', 'oxorderdate', 'desc');document.forms.showlist.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'OEEXTENDEDORDERADMIN_OXORDERDATE'), $this);?>
</a></td>
                <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, 'oxorderarticles', 'oxartnum', 'asc');document.forms.showlist.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'OEEXTENDEDORDERADMIN_OXARTNUM'), $this);?>
</a></td>
                <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, '', 'oxorderamount', 'asc');document.forms.showlist.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'OEEXTENDEDORDERADMIN_SUM'), $this);?>
</a></td>
                <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, 'oxorderarticles', 'oxtitle', 'asc');document.forms.showlist.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'OEEXTENDEDORDERADMIN_OXTITLE'), $this);?>
</a></td>
...
";
        parent.parent.sMenuSubItem = "<?php echo smarty_function_oxmultilang(array('ident' => 'OEEXTENDEDORDERADMIN_HEADER'), $this);?>
";
