<?php /* Smarty version 2.6.31, created on 2022-12-28 10:47:04
         compiled from widget/promoslider.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'widget/promoslider.tpl', 5, false),array('modifier', 'trim', 'widget/promoslider.tpl', 36, false),array('function', 'oxscript', 'widget/promoslider.tpl', 6, false),array('function', 'oxstyle', 'widget/promoslider.tpl', 7, false),)), $this); ?>
...
">
...
</span><?php if (((is_array($_tmp=$this->_tpl_vars['oArticle']->oxarticles__oxshortdesc->value)) ? $this->_run_mod_handler('trim', true, $_tmp) : trim($_tmp))): ?>
                    <br/><span class="shortdesc"><?php echo ((is_array($_tmp=$this->_tpl_vars['oArticle']->oxarticles__oxshortdesc->value)) ? $this->_run_mod_handler('trim', true, $_tmp) : trim($_tmp)); ?>
</span><?php endif; ?>
                        <?php if ($this->_tpl_vars['sBannerLink']): ?>
                    </a>
                    <?php endif; ?>
    ...
    <div class="slider-links">
        ...
        <ul>
            <?php $_from = $this->_tpl_vars['oBanners']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['promosliderlinks'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['promosliderlinks']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['iPicNr'] => $this->_tpl_vars['oBanner']):
        $this->_foreach['promosliderlinks']['iteration']++;
?>
            <?php $this->assign('oArticle', $this->_tpl_vars['oBanner']->getBannerArticle()); ?>
            <?php $this->assign('sBannerPictureUrl', $this->_tpl_vars['oBanner']->getBannerPictureUrl()); ?>
            <?php if ($this->_tpl_vars['sBannerPictureUrl']): ?>
            <li class="item<?php if ($this->_foreach['promosliderlinks']['iteration'] == 1): ?> active<?php endif; ?>">
                <?php $this->assign('sBannerLink', $this->_tpl_vars['oBanner']->getBannerLink()); ?>
                <i></i>
                <?php if ($this->_tpl_vars['sBannerLink']): ?>
                <a href="<?php echo $this->_tpl_vars['sBannerLink']; ?>
...
" target="_blank">
                <?php endif; ?>
                    <?php echo $this->_tpl_vars['oBanner']->oxactions__oxtitle->value; ?>
