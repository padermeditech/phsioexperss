...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'article_main.tpl', 1, false),array('modifier', 'oxformdate', 'article_main.tpl', 111, false),array('modifier', 'oxtruncate', 'article_main.tpl', 287, false),array('function', 'oxmultilang', 'article_main.tpl', 61, false),array('function', 'oxinputhelp', 'article_main.tpl', 65, false),)), $this); ?>
        ...
        <tr>
          <td valign="top" class="edittext" style="padding-top:10px;padding-left:10px;">
            <table cellspacing="0" cellpadding="0" border="0">
              <tr>
  <td class="edittext">
    <?php echo smarty_function_oxmultilang(array('ident' => 'SEO_TITLE'), $this);?>
&nbsp;
  </td>
  <td class="edittext">
    <input type="text" class="editinput" size="32" maxlength="<?php echo $this->_tpl_vars['edit']->oxarticles__asy_seotitle->fldmax_length; ?>
" name="editval[oxarticles__asy_seotitle]" value="<?php echo $this->_tpl_vars['edit']->oxarticles__asy_seotitle->value; ?>
" <?php echo $this->_tpl_vars['readonly']; ?>
>
    <?php echo smarty_function_oxinputhelp(array('ident' => 'HELP_SEO_TITLE'), $this);?>
...
&nbsp;
                    ...
                    <td class="edittext">
						<textarea class="editinput" name="editval[oxarticles__oxsearchkeys]" style="width:220px; height:200px; font-size:10px;"><?php echo $this->_tpl_vars['edit']->oxarticles__oxsearchkeys->value; ?>
</textarea>
...
<tr>
<td class="edittext">
Duplicate <?php echo smarty_function_oxmultilang(array('ident' => 'ARTICLE_MAIN_TITLE'), $this);?>
 #1 &nbsp;
</td>
<td class="edittext">
<input type="text" class="editinput" size="32" maxlength="<?php echo $this->_tpl_vars['edit']->oxarticles__duplicatetitle1->fldmax_length; ?>
" id="oLockTarget" name="editval[oxarticles__duplicatetitle1]" value="<?php echo $this->_tpl_vars['edit']->oxarticles__duplicatetitle1->value; ?>
">
<?php echo smarty_function_oxinputhelp(array('ident' => 'HELP_ARTICLE_MAIN_TITLE'), $this);?>
...
<td class="edittext">
<input type="text" class="editinput" size="32" maxlength="<?php echo $this->_tpl_vars['edit']->oxarticles__duplicatetitle2->fldmax_length; ?>
" id="oLockTarget" name="editval[oxarticles__duplicatetitle2]" value="<?php echo $this->_tpl_vars['edit']->oxarticles__duplicatetitle2->value; ?>
">
<?php echo smarty_function_oxinputhelp(array('ident' => 'HELP_ARTICLE_MAIN_TITLE'), $this);?>
			...
			<table>
			 <tr>
			  <td>
				...
				<textarea style="width:100%; height:150px;" class="editinput" name="editval[oxarticles__oxshortdesc]"><?php echo $this->_tpl_vars['edit']->oxarticles__oxshortdesc->value; ?>
</textarea>
			  </td>
			 </tr>
			 <tr>
