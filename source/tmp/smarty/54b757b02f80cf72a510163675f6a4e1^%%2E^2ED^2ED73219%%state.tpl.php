...
<?php echo smarty_function_oxscript(array('add' => "$( '#".($this->_tpl_vars['countrySelectId'])."' ).change( function() { $( 'select[name=\"".($this->_tpl_vars['stateSelectName'])."\"]' ).selectpicker('refresh'); } );"), $this);?>
