<?php /* Smarty version 2.6.31, created on 2022-12-28 10:46:31
         compiled from page/list/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxscript', 'page/list/list.tpl', 1, false),array('function', 'oxmultilang', 'page/list/list.tpl', 13, false),array('function', 'oxstyle', 'page/list/list.tpl', 128, false),array('function', 'oxeval', 'page/list/list.tpl', 154, false),array('modifier', 'count', 'page/list/list.tpl', 134, false),array('insert', 'oxid_tracker', 'page/list/list.tpl', 160, false),)), $this); ?>
...
" class="categoryPicture img-responsive img-thumbnail">
        ...
        <div class="page-header">
            ...
            <div class="catTitle">
				...
				<?php echo $this->_tpl_vars['actCategory']->oxcategories__oxtitle->rawValue; ?>
...
<?php if ($this->_tpl_vars['oViewConf']->isModuleActive('oepaypal') && $this->_tpl_vars['oViewConf']->showPayPalBannerOnCategoryPage()): ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "installment_banners.tpl", 'smarty_include_vars' => array('amount' => $this->_tpl_vars['paypalInstallmentPrice'],'selector' => $this->_tpl_vars['oViewConf']->getPayPalBannerCategoryPageSelector())));
