<?php /* Smarty version 2.6.31, created on 2022-12-29 15:21:15
         compiled from article_extend.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'article_extend.tpl', 1, false),array('modifier', 'oxtruncate', 'article_extend.tpl', 267, false),array('modifier', 'oxformdate', 'article_extend.tpl', 383, false),array('function', 'oxmultilang', 'article_extend.tpl', 69, false),array('function', 'oxinputhelp', 'article_extend.tpl', 90, false),array('block', 'oxhasrights', 'article_extend.tpl', 366, false),)), $this); ?>
...
<tr>
    <td class="edittext">
        <?php echo smarty_function_oxmultilang(array('ident' => 'JXPYSIOXPRESSTHEME_PACK_AMOUNT'), $this);?>

    </td>
    <td class="edittext">
        <input type="text" pattern="[0-9.]+" class="editinput" name="editval[oxarticles__jxpackamount]" value="<?php echo $this->_tpl_vars['edit']->oxarticles__jxpackamount->value; ?>
" <?php echo $this->_tpl_vars['readonly']; ?>
>
    </td>
</tr>
