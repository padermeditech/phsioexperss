...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'payment_list.tpl', 1, false),array('modifier', 'oxaddslashes', 'payment_list.tpl', 102, false),array('function', 'oxmultilang', 'payment_list.tpl', 48, false),)), $this); ?>
...
">
 ...
 payment_active<?php if ($this->_tpl_vars['listitem']->oxpayments__oxactive->value == 1): ?> active<?php endif; ?>" height="15"><div class="listitemfloating">&nbsp</a></div></td>
        <td valign="top" class="<?php echo $this->_tpl_vars['listclass']; ?>
 payment_name" height="15"><div class="listitemfloating">&nbsp;<a href="Javascript:top.oxid.admin.editThis('<?php echo $this->_tpl_vars['listitem']->oxpayments__oxid->value; ?>
