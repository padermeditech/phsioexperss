...
<p class="desc">
    ...
    Die Fehlermeldung &quot;die Lizenz ist abgelaufen&quot; weist darauf hin, dass die Testlizenz f&uuml;r das Simple Search von draufgeschaut.de bereits in Ihrem Shop aktiviert wurde. <br /><br />
...
<div class="messagebox">
 <p>
   ...
   Erweiterungen > Module > Simple Search <br /><br />
   Vergessen Sie nicht eventuelle Cronjobs ebenfalls zu deaktivieren.<br />
   <br />
   Danke f&uuml;r Ihr Interresse an unseren Modul Simple Search.
 </p>
</div>
