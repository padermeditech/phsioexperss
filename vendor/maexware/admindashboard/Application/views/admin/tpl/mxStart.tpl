...
<frameset cols="200,*" border="0" id="mwTopFrame">
    ...
    <frameset  rows="54,*" border="0">
        <frame src="[{$oViewConf->getSelfLink()}]&cl=navigation&item=mxStartMenu.tpl" name="header" id="header" frameborder="0" scrolling="No" noresize marginwidth="0" marginheight="0">
        <frame src="[{$oViewConf->getSelfLink()}]&cl=navigation&item=mxAdminDashboard.tpl" name="basefrm" id="basefrm" frameborder="0" scrolling="Auto" noresize marginwidth="0" marginheight="0">
    </frameset>
</frameset>
